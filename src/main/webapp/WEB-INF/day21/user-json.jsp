...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="user-json">User Directory</a>
    ...
    <div class="row">
        <c:forEach items="${users}" var="user">
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                <div class="card mb-4">
                    <img class="card-img-top rounded" src="${user.picture.large}" alt="${user.name.first} ${user.name.last}">
                    <div class="card-body">
                        <h5 class="card-title">${user.name.first} <br> ${user.name.last}</h5>
                        <h6 class="card-subtitle mb-2 text-muted">${user.location.city}, <br> ${user.location.state}</h6>
